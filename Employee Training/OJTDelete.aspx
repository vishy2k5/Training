<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.Master" AutoEventWireup="true" CodeBehind="OJTDelete.aspx.cs" Inherits="Employee_Training.OJTDelete" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Body" runat="server">
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td>Code</td>
            <td>
                <asp:DropDownList ID="drpCode" runat="server" Width="210px"  Height="35px" CssClass="textbox" >
                </asp:DropDownList>
            </td>
            <td style="width:20%">&nbsp;</td>
        </tr>
